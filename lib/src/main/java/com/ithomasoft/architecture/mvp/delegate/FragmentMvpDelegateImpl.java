...
import com.ithomasoft.architecture.BackstackAccessor;
import com.ithomasoft.architecture.PresenterManager;
...
public class FragmentMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
  ...
  protected static final String KEY_MOSBY_VIEW_ID = "com.ithomasoft.architecture.fragment.mvp.id";
